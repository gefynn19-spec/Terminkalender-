...
const SRC = '/home/user/Terminkalender-/social-media/kinder-edition';
const OUT = '/home/user/Terminkalender-/social-media/kinder-edition/export';
fs.mkdirSync(OUT, { recursive: true });

const fontCss = fs.readFileSync('fonts/inline.css', 'utf-8');
const slides = [
  ['Main.dc.html', '01-hook'],
  ['Anzeichen.dc.html', '02-anzeichen'],
  ['Training.dc.html', '03-training'],
...
for (const [file, name] of slides) {
  ...
  await el.screenshot({ path: path.join(OUT, `kinder-edition-${name}.png`) });
